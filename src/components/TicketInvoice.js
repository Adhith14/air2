...
// const TicketInvoice = ({ bookedTicket, onClose, numberOfGuests }) => {
//   const guests = parseInt(numberOfGuests) || 1;
//   const pricePerPerson = parseFloat(bookedTicket.price) || 0;
//   const totalPrice = pricePerPerson * guests;

//   return (
//     <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-500 bg-opacity-50">
//       <div className="bg-white p-6 rounded-lg shadow-md max-w-lg">
//         <h2 className="text-lg font-semibold mb-4">Ticket Invoice</h2>
//         <div className="mb-4">
//           <p>
//             <strong>Flight Number:</strong> {bookedTicket.flightNbr}
//           </p>
//           <p>
//             <strong>Airline:</strong> {bookedTicket.airlineName}
//           </p>
//           <p>
//             <strong>Departure Time:</strong> {bookedTicket.deptTime}
//           </p>
//           <p>
//             <strong>Departure City:</strong> {bookedTicket.deptCity}
//           </p>
//           <p>
//             <strong>Arrival Time:</strong> {bookedTicket.arivalTime}
//           </p>
//           <p>
//             <strong>Arrival City:</strong> {bookedTicket.arivalCity}
//           </p>
//           <p>
//             <strong>Stops:</strong> {bookedTicket.noOfStops}
//           </p>
//           <p>
...
//             onClick={onClose}
//           ><Link to={'/SeatSelection'}  style={{textDecoration:'none'}}>
