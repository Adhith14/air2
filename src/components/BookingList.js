...
// const BookingList = ({ flightResults, onShowInvoice }) => {
//   const handleBookTicket = (flight) => {
//     onShowInvoice(flight);
//   };
...
//             <div className="px-2">{flight.className}</div>
//             <div className="px-2">{flight.deptTime}</div>
//             <div className="px-2">{flight.deptCity}</div>
//             <div className="px-2">{flight.arivalTime}</div>
//             <div className="px-2">{flight.arivalCity}</div>
//             <div className="px-2">{flight.noOfStops}</div>
//             <div className="px-2">{flight.price}</div>
//             <div className="px-2">
//               <button
