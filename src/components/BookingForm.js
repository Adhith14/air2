...
//   const handleSearch = () => {
//     const filteredFlights = flightDetailsData.filter(
//       (flight) =>
...
//     );
//     setFlightResults(filteredFlights);
//   };
...
// import BookingList from './BookingList';
// import TicketInvoice from './TicketInvoice';
// import TwoWayBookingList from './TwoWayBookingList';
...
//   });
//   const [flightResults, setFlightResults] = useState([]);
//   const [twoWayFlightResults, setTwoWayFlightResults] = useState([]);
//   const [showInvoice, setShowInvoice] = useState(false);
//   const [selectedTicket, setSelectedTicket] = useState(null);
...
//       const filteredTwoWayFlights = flightDetailsData.filter(
//         (flight) =>
...
//       );
//       setTwoWayFlightResults(filteredTwoWayFlights);
//     } else {
//       setTwoWayFlightResults([]);
//     }
//   };
...
//     {bookingData.roundTrip && (
//       <TwoWayBookingList
//         flightResults={twoWayFlightResults}
//         onShowInvoice={handleShowInvoice}
//       />
//     )}
//     {showInvoice && (
...
//   const handleSearch = () => {
//     const filteredOutboundFlights = flightDetailsData.filter(
//       (flight) =>
//         flight.deptCity === bookingData.destinationFrom &&
//         flight.arivalCity === bookingData.destinationTo &&
//         flight.className === bookingData.travelClass &&
