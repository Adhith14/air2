...
//               <Nav.Link href="#skills" className={activeLink === 'signup' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('signup')}>Sign Up</Nav.Link>
//               <Nav.Link href="#projects" className={activeLink === 'signin' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('signin')}>Sign In</Nav.Link>
//             </Nav>
